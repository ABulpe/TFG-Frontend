            ...
            onSubmit={ async (values) => {
                ...
                try {
                    if (type === 'business') {
                        ...
                        const businessResponse = addBusiness(businessValues)

                        businessResponse.then(response => {
                            if (response.message) setError('No se pudo agregar el comercio.')
                            else navigateToList()
                        })
                        ...
                        const entityResponse = addEntity(values)
                        
                        entityResponse.then(response => {
                            if (response.message) setError('No se pudo agregar la entidad.')
                            else navigateToList()
                        })
                    }
                }
                ...
                >
                    ...
                    >
                        ...
                        <Field
                            ...
                            onChange={handleChange}
                        />
                        <Span className='form-label'>Dirección (calle)</Span>
                    </Label>
                    <Label 
                    ...
                    >
                        ...
                        <Field
                            ...
                            onChange={handleChange}
                        />
                        <Span className='form-label'>Dirección (número)</Span>
                    </Label>
                    <Label 
                        htmlFor='postalCode'
                        className='auth-label'
